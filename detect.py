...
def parse_opt():
    ...
    parser.add_argument('--source', type=str, default=r"D:/yanbo/无人机检测与追踪/无人机检测与追踪/test/3700000000002_140908_1", help='file/dir/URL/glob/screen/0(webcam)')
    ...
    parser.add_argument('--device', default='', help='cuda device, qqi.e. 0 or 0,1,2,3 or cpu')
